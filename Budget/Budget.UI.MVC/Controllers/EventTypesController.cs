...
namespace Budget.UI.MVC.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public EventTypesController(BudgetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EventTypes != null ? 
                          View(await _context.EventTypes.ToListAsync()) :
                          Problem("Entity set 'BudgetContext.EventTypes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("EventTypeId,EventTypeName,EventTypeDesc")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventTypeId,EventTypeName,EventTypeDesc")] EventType eventType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BudgetContext.EventTypes'  is null.");
            }
            var eventType = await _context.EventTypes.FindAsync(id);
            if (eventType != null)
            {
